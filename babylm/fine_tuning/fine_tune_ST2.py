...
df = pd.read_csv("../data/WaM.train.tsv", delimiter = '\t', header = None, names = ['word_a', 'word_b', 'label'], skiprows = 1)
...
val_df = pd.read_csv("../data/WaM.dev.tsv", header=None, delimiter='\t', skiprows=1, names=['word_a', 'word_b', 'label'])
...
df = pd.read_csv("../data/WaM.test.tsv", delimiter='\t', header = None, names = ['word_a', 'word_b', 'label'], skiprows = 1)
# df.dropna(inplace = True)
