...
torchrun --nnodes=1 --nproc_per_node=1 \
    train.py --input_path "../data/processed_100M/cached_{sequence_length}.txt" --input_valid_path "../data/processed_dev/cached_{sequence_length}.txt" --validation_freq 5000 --validation_max_steps 500 --config_file "../configs/small.json" --output_dir "../checkpoints/small" --vocab_path "../tokenizer.json" --batch_size 400 --max_steps 100000 --learning_rate 0.01 --long_after 1.0
