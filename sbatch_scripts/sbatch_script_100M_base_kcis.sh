...
torchrun --nnodes=1 --nproc_per_node=1 \
	train.py --input_path "../data/processed_100M/cached_{sequence_length}.txt" --config_file "../configs/base.json" --output_dir "../checkpoints/base" --vocab_path "../tokenizer.json" --batch_size 400 --max_steps 100000 --long_after 1.0
