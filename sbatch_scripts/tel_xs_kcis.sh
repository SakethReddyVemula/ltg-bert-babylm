...
#SBATCH --output=tel_s_BPE_v16325.txt
...
torchrun --nnodes=1 --nproc_per_node=1 \
	train.py --input_path "../data/te/cached_{sequence_length}_train.txt" --input_valid_path "../data/te/cached_{sequence_length}_dev.txt" --validation_freq 5000 --validation_max_steps 500 --config_file "../configs/small.json" --output_dir "../checkpoints/small" --vocab_path "../te_BPE_16325.json" --batch_size 400 --max_steps 100000 --learning_rate 0.01 --long_after 1.0
