...
torchrun --nnodes=1 --nproc_per_node=4 \
	train.py --input_path "../data/en/cached_{sequence_length}_train.txt" --input_valid_path "../data/en/cached_{sequence_length}_dev.txt" --validation_freq 5000 --validation_max_steps 500 --config_file "../configs/xs_v50227.json" --output_dir "../checkpoints/xs" --vocab_path "../tokenizers/en/en_BPE_50227.json" --batch_size 200 --max_steps 100000 --learning_rate 0.01 --long_after 1.0
