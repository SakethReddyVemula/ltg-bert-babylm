...
torchrun --nnodes=1 --nproc_per_node=4 \
    train.py --input_path "../data/processed_10M/cached_{sequence_length}.txt" --config_file "../configs/xs.json" --output_dir "../checkpoints/xs" --vocab_path "../tokenizer.json" --batch_size 64 --max_steps 500 --long_after 1.0
